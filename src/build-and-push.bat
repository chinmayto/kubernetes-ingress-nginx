...
REM Set your ECR registry URL (replace with your actual registry)
set ECR_REGISTRY=<your-account-id>.dkr.ecr.<region>.amazonaws.com

REM Login to ECR Public
aws ecr-public get-login-password --region us-east-1 | docker login --username AWS --password-stdin public.ecr.aws

REM Build and push app1
echo Building app1...
cd app1
